  ...
  switch (blockId) {
    case "A": return [
      ...
      { id: "A5", q: "Is the device subject to third-party conformity assessment under MDR/IVDR?", type: "yesno",
        skip: !hasEU,
        help: "Devices with third-party conformity assessment classify as high-risk under the EU AI Act (Article 6). Obligations apply from Aug 2, 2027 for Annex I devices (note: subject to possible delay under pending EU Digital Omnibus proposal — verify current timeline). This applies under both MDR 2017/745 and IVDR 2017/746." },
    ...
    case "E": return [
      { id: "E1", q: "Does the training, validation, or test data adequately represent the device's intended patient population?", type: "yesnouncertain",
        draftRef: true,
        help: "FDA AI-DSF Lifecycle Guidance (Jan 2025 draft — not yet finalized; verify current status at fda.gov) recommends bias analysis across intended populations. Note: this recommendation derives from draft guidance, which does not establish legally enforceable requirements. Health Canada mandates equity assessment for AI/ML device changes." },
