    ...
    >
      ...
      >
        ...
        <div style={{ marginBottom: 72 }}>
          ...
          >
            An early prototype for structured assessment of AI-enabled medical device changes. Review the authorized
            baseline, work through change classification and significance, and document a proposed pathway with
            supporting rationale and open issues.
          </p>
          <div
            style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                ...
                <p style={{ fontSize: 13, color: 'var(--color-text-secondary)', lineHeight: 1.5, margin: 0 }}>
                  Begin a new assessment from device profile through change classification, significance review, pathway
        ...
        <section style={{ marginBottom: 72 }}>
          ...
          >
            Browse nine realistic AI/ML change-review scenarios to see how the current workflow routes them. Samples
            open from source-controlled answers and do not replace the in-progress draft saved in this browser.
          </p>
        ...
        <section>
          ...
          >
            ...
            >
              ...
              regulatory determination and does not replace qualified regulatory, legal, clinical, quality, or
              engineering judgment. Outputs must be reviewed by qualified personnel against applicable regulations and
              organizational procedures before any reliance or action.
            </p>
          </div>
        </section>
      </main>
