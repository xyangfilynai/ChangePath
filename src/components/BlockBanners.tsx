...
export const BlockBanners: React.FC<BlockBannersProps> = React.memo(
  ({ blockId, answers, derivedState, currentBlockComplete, currentMissingRequired }) => {
    return (
      <>
          ...
          answers.C0_DN2 === Answer.Uncertain ? (
            <div style={bannerStyle.danger}>
              ...
              <div>
                ...
                <div style={{ fontSize: 12.5, color: 'var(--color-text-secondary)', lineHeight: 1.6, marginTop: 4 }}>
                  The modified device may not remain within the De Novo device type and special controls. Consider an
                  FDA Pre-Submission (Q-Sub) or senior RA review before treating any documentation-only pathway as
                  sufficient.
                </div>
              </div>
            </div>
            ...
            return (
              ...
              >
                ...
                <div>
                  ...
                  {pccpNote && (
                    <div
                      style={{ fontSize: 12.5, color: 'var(--color-text-secondary)', lineHeight: 1.6, marginTop: 4 }}
                    >
                      {pccpNote}
                    </div>
                  )}
